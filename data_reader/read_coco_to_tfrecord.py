...
annFile='/dta/Datasets/coco_data/coco/annotations/instances_train2014.json'

# COCO训练集的图像数据保存的目录
train_path = '/dta/Datasets/coco_data/coco/images/train2014'
coco=COCO(annFile)
...
if __name__ == '__main__':
    ...
    starttime=time.time()        
    total_processed = process_in_queues(train_images, cores, targetfolder='/dta/Datasets/coco_data/coco/')
    endtime=time.time()
